...
namespace Microsoft.Extensions.Primitives
{
	...
	/// </summary>
	public struct StringSegment2 : IEquatable<StringSegment2>, IEquatable<string>
	{
		/// <summary>
		/// A <see cref="StringSegment2"/> for <see cref="string.Empty"/>.
		/// </summary>
		public static readonly StringSegment2 Empty = string.Empty;

		/// <summary>
		/// Initializes an instance of the <see cref="StringSegment2"/> struct.
		/// </summary>
		/// <param name="buffer">
		/// The original <see cref="string"/>. The <see cref="StringSegment2"/> includes the whole <see cref="string"/>.
		/// </param>
		public StringSegment2(string buffer)
		{
			Buffer = buffer;
			Offset = 0;
		...
		public StringSegment2(string buffer, int offset, int length)
		{
		...
		/// <inheritdoc />
		public override bool Equals(object obj) => obj is StringSegment1 segment && Equals(segment);
		...
		public bool Equals(StringSegment2 other)
		{
		...
		public static bool operator ==(StringSegment2 left, StringSegment2 right)
		{
		...
		public static implicit operator StringSegment2(string value)
		{
			return new StringSegment2(value);
		}
		...
		public static implicit operator ReadOnlySpan<char>(StringSegment2 segment) => segment.AsSpan();
		...
		public static implicit operator ReadOnlyMemory<char>(StringSegment2 segment) => segment.AsMemory();
