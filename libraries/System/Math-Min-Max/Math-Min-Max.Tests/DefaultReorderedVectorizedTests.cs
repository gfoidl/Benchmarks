...
{
    public static class DefaultReorderedVectorizedTests
    {
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorized.Max(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorized.Max(x, y), 0.0f);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorized.Min(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorized.Min(x, y), 0.0f);
        }
    }
}
