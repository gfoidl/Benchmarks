...
namespace System.Tests
{
    public static class DefaultTests
    {
        ...
        {
            AssertEqual(expectedResult, Default.Max(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, Default.Max(x, y), 0.0f);
        }
        ...
        {
            AssertEqual(expectedResult, Default.Min(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, Default.Min(x, y), 0.0f);
        }
    }
}
