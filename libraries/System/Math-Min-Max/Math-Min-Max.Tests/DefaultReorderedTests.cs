...
{
    public static class DefaultReorderedTests
    {
        ...
        {
            AssertEqual(expectedResult, DefaultReordered.Max(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReordered.Max(x, y), 0.0f);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReordered.Min(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReordered.Min(x, y), 0.0f);
        }
    }
}
