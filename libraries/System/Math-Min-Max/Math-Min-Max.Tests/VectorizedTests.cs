...
{
    public static class VectorizedTests
    {
        ...
        {
            AssertEqual(expectedResult, Vectorized.Max(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, Vectorized.Max(x, y), 0.0f);
        }
        ...
        {
            AssertEqual(expectedResult, Vectorized.Min(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, Vectorized.Min(x, y), 0.0f);
        }
    }
}
