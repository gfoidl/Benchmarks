...
{
    public static class DefaultReorderedVectorizedHotColdTests
    {
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorizedHotCold.Max(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorizedHotCold.Max(x, y), 0.0f);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorizedHotCold.Min(x, y), 0.0);
        }
        ...
        {
            AssertEqual(expectedResult, DefaultReorderedVectorizedHotCold.Min(x, y), 0.0f);
        }
    }
}
