...
{
    public static class DefaultReorderedVectorizedHotCold
    {
        ...
        public static double Max(double val1, double val2)
        {
            ...
            if (val1 != val2 && !IsNaN(val1))
            {
                if (Sse2.IsSupported)
                {
                    ...
                    return Sse2.MaxScalar(lhs, rhs).ToScalar();
                }

                return val2 < val1 ? val1 : val2;
            }

            return MaxSpecialCases(val1, val2);
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static double MaxSpecialCases(double val1, double val2)
        {
            if (IsNaN(val1))
            {
                return val1;
        ...
        public static float Max(float val1, float val2)
        {
            ...
            if (val1 != val2 && !IsNaN(val1))
            {
                if (Sse.IsSupported)
                {
                    ...
                    return Sse.MaxScalar(lhs, rhs).ToScalar();
                }
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static float MaxSpecialCases(float val1, float val2)
        {
            if (IsNaN(val1))
            {
                return val1;
        ...
        public static double Min(double val1, double val2)
        {
            ...
            if (val1 != val2 && !IsNaN(val1))
            {
                if (Sse2.IsSupported)
                {
                    Vector128<double> lhs = Vector128.CreateScalarUnsafe(val1);
                    Vector128<double> rhs = Vector128.CreateScalarUnsafe(val2);
                    return Sse2.MinScalar(lhs, rhs).ToScalar();
                }

                return val1 < val2 ? val1 : val2;
            }

            return MinSpecialCases(val1, val2);
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private static double MinSpecialCases(double val1, double val2) => IsNegative(val1) ? val1 : val2;
        ...
        [MethodImpl(MethodImplOptions.NoInlining)]
        private static float MinSpecialCases(float val1, float val2) => IsNegative(val1) ? val1 : val2;
