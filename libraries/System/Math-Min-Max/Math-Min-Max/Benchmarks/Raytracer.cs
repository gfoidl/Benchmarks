...
// Copied (and modified) from https://gist.github.com/mattwarren/d17a0c356bd6fdb9f596bee6b9a5e63c
...
#if NETSTANDARD2_1 || NETCOREAPP2_0 || NETCOREAPP2_1 || NETCOREAPP2_2 || NETCOREAPP3_0 || NETCOREAPP5_0
            ...
            using (var writer = new BinaryWriter(fileStream, Encoding.ASCII))
            {
                ...
                for (int y = (h - 1); y >= 0; y--)
                {
                    for (int x = (w - 1); x >= 0; x--)
                    {
                        ...
                        s_buffer[2] = (byte)(int)color.z;
                        s_buffer[1] = (byte)(int)color.y;
                        s_buffer[0] = (byte)(int)color.x;
