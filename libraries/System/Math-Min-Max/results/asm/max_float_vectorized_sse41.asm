...
;  V03 tmp1         [V03,T05] (  2,  2   )   float  ->  mm0         "Inline return value spill temp"
...
;  V07 tmp5         [V07,T06] (  2,  2   )  simd16  ->  mm3         "Inline stloc first use temp"
;  V08 tmp6         [V08,T07] (  2,  2   )  simd16  ->  mm1         "Inline stloc first use temp"
...
G_M34552_IG02:
       C5FA5FD1             vmaxss   xmm2, xmm0, xmm1
       C5FAC2D900           vcmpss   xmm3, xmm0, xmm1, 0
       C5F854C9             vandps   xmm1, xmm0, xmm1
       C4E3694AD130         vblendvps xmm2, xmm2, xmm1, xmm3
...
; Total bytes of code 34, prolog size 3, PerfScore 17.13, (MethodHash=1ab87907) for method Math_Min_Max.Program:Do(float,float):float
; ============================================================
