...
G_M34552_IG02:
       ...
       C5E055D2             vandnps  xmm2, xmm3, xmm2
       C5E054C9             vandps   xmm1, xmm3, xmm1
       C5F056D2             vorps    xmm2, xmm1, xmm2
...
; Total bytes of code 46, prolog size 3, PerfScore 18.93, (MethodHash=1ab87907) for method Math_Min_Max.Program:Do(float,float):float
; ============================================================
