...
G_M34552_IG02:
       E89FFDFFFF           call     Math_Min_Max.Variants.Default:Max(float,float):float
       90                   nop
...
; Assembly listing for method Math_Min_Max.Variants.Default:Max(float,float):float
; Emitting BLENDED_CODE for X64 CPU with AVX - Unix
; optimized code
; rbp based frame
; partially interruptible
...
G_M61458_IG02:
       ...
       770A                 ja       SHORT G_M61458_IG04
                        ;; bbWeight=1    PerfScore 2.00
G_M61458_IG03:
       C5F82EC0             vucomiss xmm0, xmm0
       7A03                 jp       SHORT G_M61458_IG04
       7407                 je       SHORT G_M61458_IG05
...
G_M61458_IG05:
       C5F82EC1             vucomiss xmm0, xmm1
       7A20                 jp       SHORT G_M61458_IG09
       751E                 jne      SHORT G_M61458_IG09
       C5FA1145FC           vmovss   dword ptr [rbp-04H], xmm0
       837DFC00             cmp      dword ptr [rbp-04H], 0
       7C08                 jl       SHORT G_M61458_IG07
...
; Total bytes of code 78, prolog size 13, PerfScore 21.65, (MethodHash=b4440fed) for method Math_Min_Max.Variants.Default:Max(float,float):float
; ============================================================
