...
;  V03 tmp1         [V03,T05] (  2,  2   )  double  ->  mm0         "Inline return value spill temp"
...
G_M19037_IG02:
       ...
       C4E3694BD130         vblendvpd xmm2, xmm2, xmm1, xmm3
...
; Total bytes of code 34, prolog size 3, PerfScore 17.13, (MethodHash=649cb5a2) for method Math_Min_Max.Program:Do(double,double):double
; ============================================================
