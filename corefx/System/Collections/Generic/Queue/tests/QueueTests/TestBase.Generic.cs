...
namespace System.Collections.Tests
{
    ...
    public abstract class TestBase<T> : TestBase
    {
        ...
        /// EnumerableType to test on (e.g. HashSet, Queue1), and size of set to test with (e.g. 0, 1, etc.).
        /// </summary>
            ...
            foreach (object[] collectionSizeArray in ValidCollectionSizes())
            {
                foreach (EnumerableType enumerableType in Enum.GetValues(typeof(EnumerableType)))
                {
                    ...
                    if (count >= 2)
                    {
                        ...
                        if ((enumerableType == EnumerableType.List || enumerableType == EnumerableType.Queue1))
        ...
        /// <summary>
        /// Helper function to create a Queue1 fulfilling the given specific parameters. The function will
        /// create an Queue1 and then add values
