...
namespace System.Collections.Tests
{
    ...
    /// no common interface exists. This area is shared by the very similar Queue1 and Stack0.
    ...
    public abstract class IGenericSharedAPI_Tests<T> : IEnumerable_Generic_Tests<T>
    {
        ...
        // There are a number of methods shared between Queue1, and Stack0 for which there is no
