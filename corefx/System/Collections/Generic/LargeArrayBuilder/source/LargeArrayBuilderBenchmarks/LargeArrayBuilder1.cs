...
{
	/// <summary>
	/// Represents a position within a <see cref="LargeArrayBuilder1{T}"/>.
	/// </summary>
	...
	internal readonly struct CopyPosition
	{
		...
		/// <summary>
		/// Represents a position at the start of a <see cref="LargeArrayBuilder1{T}"/>.
		/// </summary>
	...
	internal struct LargeArrayBuilder1<T>
	{
		...
		public LargeArrayBuilder1(bool initialize)
		...
		/// </remarks>
		public LargeArrayBuilder1(int maxCapacity)
			: this()
		{
		...
		// Non-inline to improve code quality as uncommon path
		[MethodImpl(MethodImplOptions.NoInlining)]
		private void AddWithBufferAllocation(in T item, ref T[] destination, ref int index)
		{
			_count += index - _index;
			_index = index;
			AllocateBuffer();
