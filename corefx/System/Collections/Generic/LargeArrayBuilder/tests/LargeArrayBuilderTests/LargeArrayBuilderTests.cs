...
namespace System.Collections.Generic.Tests
{
    public abstract class LargeArrayBuilderTests<T, TGenerator> where TGenerator : IGenerator<T>, new()
    {
        ...
        {
            var builder = new LargeArrayBuilder1<T>(initialize: true);
        ...
        {
            var builder1 = new LargeArrayBuilder1<T>(initialize: true);
            var builder2 = new LargeArrayBuilder1<T>(initialize: true);
        ...
        {
            var builder = new LargeArrayBuilder1<T>(maxCapacity);
