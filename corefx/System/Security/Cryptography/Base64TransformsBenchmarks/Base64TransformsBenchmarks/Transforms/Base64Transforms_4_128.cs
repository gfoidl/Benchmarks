...
{
    public class FromBase64Transform_4_128 : ICryptoTransform
    {
        private byte[] _inputBuffer = new byte[4];
        private int _inputIndex;
        private readonly FromBase64TransformMode _whitespaces;

        public FromBase64Transform_4_128() : this(FromBase64TransformMode.IgnoreWhiteSpaces) { }
        public FromBase64Transform_4_128(FromBase64TransformMode whitespaces)
        {
        ...
        public int TransformBlock(byte[] inputBuffer, int inputOffset, int inputCount, byte[] outputBuffer, int outputOffset)
        {
            ...
            {
                tmpBuffer = inputCount <= 128
                    ? stackalloc byte[128]
                    : tmpBufferArray = CryptoPool.Rent(inputCount);
            }
