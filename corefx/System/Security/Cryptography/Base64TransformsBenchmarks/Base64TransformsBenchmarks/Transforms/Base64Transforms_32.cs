...
{
    public class FromBase64Transform_32 : ICryptoTransform
    {
        private byte[] _inputBuffer = new byte[4];
        private int _inputIndex;
        private readonly FromBase64TransformMode _whitespaces;

        public FromBase64Transform_32() : this(FromBase64TransformMode.IgnoreWhiteSpaces) { }
        public FromBase64Transform_32(FromBase64TransformMode whitespaces)
        {
