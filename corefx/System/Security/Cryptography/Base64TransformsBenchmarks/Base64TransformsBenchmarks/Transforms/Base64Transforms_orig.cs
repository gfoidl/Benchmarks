...
{
    public class ToBase64Transform_orig : ICryptoTransform
    {
    ...
    public class FromBase64Transform_orig : ICryptoTransform
    {
        private byte[] _inputBuffer = new byte[4];
        private int _inputIndex;
        private FromBase64TransformMode _whitespaces;

        public FromBase64Transform_orig() : this(FromBase64TransformMode.IgnoreWhiteSpaces) { }
        public FromBase64Transform_orig(FromBase64TransformMode whitespaces)
        {
