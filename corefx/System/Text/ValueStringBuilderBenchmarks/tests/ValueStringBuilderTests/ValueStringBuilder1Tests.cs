...
{
    public class ValueStringBuilder1Tests
    {
        [Fact]
        public void Ctor_Default_CanAppend()
        {
            var vsb = default(ValueStringBuilder1);
        ...
        {
            var vsb = new ValueStringBuilder1(new char[1]);
            Assert.Equal(0, vsb.Length);
        ...
        public void Append_Char_MatchesStringBuilder()
        {
            ...
            var vsb = new ValueStringBuilder1();
            for (int i = 1; i <= 100; i++)
            {
                sb.Append((char)i);
                vsb.Append((char)i);
        ...
        public void Append_String_Large_MatchesStringBuilder(int initialLength, int stringLength)
        {
            ...
            var vsb = new ValueStringBuilder1(new char[initialLength]);
