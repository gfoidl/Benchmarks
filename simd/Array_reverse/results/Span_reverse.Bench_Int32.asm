...
;* V05 tmp4         [V05    ] (  0,  0   )     int  ->  zero-ref    ld-addr-op "Inline ldloca(s) first use temp"
...
G_M55368_IG02:
       ...
       4885FF               test     rdi, rdi
       7506                 jne      SHORT G_M55368_IG04

G_M55368_IG03:		;; bbWeight=0.50
       33FF                 xor      rdi, rdi
       33F6                 xor      esi, esi
       EB0A                 jmp      SHORT G_M55368_IG05

G_M55368_IG04:		;; bbWeight=0.50
...
G_M55368_IG05:
       83FE01               cmp      esi, 1
       7E05                 jle      SHORT G_M55368_IG07

G_M55368_IG06:		;; bbWeight=0.50
       E8E877FFFF           call     Bench`1:ReverseVectorized(byref,int)
...
; Total bytes of code 43, prolog size 5, perf score 12.05, (MethodHash=fd3b27d3) for method Bench`1:ReverseVectorized():this
; ============================================================
...
;  V07 loc5         [V07,T09] (  7, 28   )  simd32  ->  mm0        
;  V08 loc6         [V08,T10] (  7, 28   )  simd32  ->  mm1        
;  V09 loc7         [V09,T11] (  4, 16   )  simd16  ->  mm0        
;  V10 loc8         [V10,T12] (  4, 16   )  simd16  ->  mm1        
;  V11 loc9         [V11,T02] (  2,  8   )     int  ->  rsi        
;  V12 loc10        [V12,T03] (  2,  8   )     int  ->  rdx        
...
G_M55340_IG02:
       ...
       488D0487             lea      rax, [rdi+4*rax]
       83FE10               cmp      esi, 16
       7C59                 jl       SHORT G_M55340_IG07

G_M55340_IG03:		;; bbWeight=0.50
       4883C720             add      rdi, 32
       4883C0E0             add      rax, -32

G_M55340_IG04:		;; bbWeight=4   
       C5FE6F47E0           vmovdqu  ymm0, ymmword ptr[rdi-32]
       C5FE6F08             vmovdqu  ymm1, ymmword ptr[rax]
       C5FD70C01B           vpshufd  ymm0, ymm0, 27
       C5FD70C91B           vpshufd  ymm1, ymm1, 27
       ...
       4883C0E0             add      rax, -32
       483BF8               cmp      rdi, rax
       76CB                 jbe      SHORT G_M55340_IG04

G_M55340_IG05:		;; bbWeight=0.50
       4883C7E0             add      rdi, -32
       4883C020             add      rax, 32
       483BF8               cmp      rdi, rax
       7209                 jb       SHORT G_M55340_IG07

G_M55340_IG06:		;; bbWeight=0.50
       C5F877               vzeroupper 
       488D6500             lea      rsp, [rbp]
       5D                   pop      rbp
       C3                   ret      

G_M55340_IG07:		;; bbWeight=0.50
       488BF0               mov      rsi, rax
       482BF7               sub      rsi, rdi
       4883FE20             cmp      rsi, 32
       7C4D                 jl       SHORT G_M55340_IG11
       4883C710             add      rdi, 16
       4883C0F0             add      rax, -16

G_M55340_IG08:		;; bbWeight=4   
       C5FA6F47F0           vmovdqu  xmm0, xmmword ptr [rdi-16]
       C5FA6F08             vmovdqu  xmm1, xmmword ptr [rax]
       C5F970C01B           vpshufd  xmm0, xmm0, 27
       C5F970C91B           vpshufd  xmm1, xmm1, 27
       C5FA7F4FF0           vmovdqu  xmmword ptr [rdi-16], xmm1
       C5FA7F00             vmovdqu  xmmword ptr [rax], xmm0
       4883C710             add      rdi, 16
       4883C0F0             add      rax, -16
       483BF8               cmp      rdi, rax
       76D7                 jbe      SHORT G_M55340_IG08

G_M55340_IG09:		;; bbWeight=0.50
       4883C7F0             add      rdi, -16
       4883C010             add      rax, 16
       483BF8               cmp      rdi, rax
       7209                 jb       SHORT G_M55340_IG11

G_M55340_IG10:		;; bbWeight=0.50
       C5F877               vzeroupper 
       488D6500             lea      rsp, [rbp]
       5D                   pop      rbp
       C3                   ret      

G_M55340_IG11:		;; bbWeight=0.50
       4883C0FC             add      rax, -4
       483BF8               cmp      rdi, rax
       7315                 jae      SHORT G_M55340_IG13

G_M55340_IG12:		;; bbWeight=4   
       ...
       4883C0FC             add      rax, -4
       483BF8               cmp      rdi, rax
       72EB                 jb       SHORT G_M55340_IG12

G_M55340_IG13:		;; bbWeight=0.50
       33C0                 xor      rax, rax
       488945F8             mov      bword ptr [rbp-08H], rax

G_M55340_IG14:		;; bbWeight=0.50
       C5F877               vzeroupper 
       488D6500             lea      rsp, [rbp]
       5D                   pop      rbp
       C3                   ret      

; Total bytes of code 246, prolog size 19, perf score 150.80, (MethodHash=fd3b27d3) for method Bench`1:ReverseVectorized(byref,int)
; ============================================================
00 01 02 03 04 
